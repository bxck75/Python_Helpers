...
class WGAN_GP:
    ...
    def build_model(self):
        ...
        # gradient penality
        """ Gradient Penalty """
        epislon = tf.random_uniform(shape=self.input_data.get_shape(), minval=0.,maxval=1.)
        interpolates = epislon*self.input_data + (1-epislon)*(self.G_sample)
        ...
        self.g_optimization = tf.train.AdamOptimizer(self.learning_rate*5, beta1=self.beta1).minimize(self.g_loss, var_list=self.g_vars)
