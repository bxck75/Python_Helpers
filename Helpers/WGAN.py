    ...
    def train(self):        
        ...
        for index in range(self.epoch):
            ...
            for idx in range(batch_idxs):
                ...
                _, _ = self.sess.run([self.d_optimization, self.clip_updates], feed_dict={self.input_data:batch_x, self.z:batch_z})
